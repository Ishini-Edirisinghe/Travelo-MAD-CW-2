...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // StreamBuilder listens to user changes (updates, sign-in, etc.)
    return StreamBuilder<User?>(
      stream: FirebaseAuth.instance.userChanges(),
      builder: (context, snapshot) {
        // If waiting for data, show loading (optional, usually instant)
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      // ✅ USER NAME (Updates automatically now)
                      Text(
                        name,
                      ...
                      // ✅ USER EMAIL (Updates automatically now)
                      Text(
                        email,
                        style: const TextStyle(
  ...
  // Helper method for Delete Dialog to keep build method clean
